<?php
    ...
    require_once '../model/cart.model.php';
     if ($_SESSION) {
         ...
         $getCatById = $item->getItemBySubCat($_GET['id']); ?>
<!doctype html>
<html lang="en">
...
<head>  <!-- Required meta tags -->
  ...
  <title>By Category Products - Bakpak</title>
      ...
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand text-center">
            <h1 class="title text-center" style="font-family: 'Century Gothic'; background-color: rgba(0,0,0,0.8); padding: 10px; border-radius: 50px;"><?php $getSubCat = $SubCat->getSubCatById($_GET['id']);
         echo $getSubCat['sub_category_name']; ?></h1>
          </div>
        </div>
      </div>
    </div>
