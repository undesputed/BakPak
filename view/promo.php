      ...
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
          <div class="brand text-center">
            <h1 class="title text-center" style="font-family: 'Century Gothic'; background-color: rgba(0,0,0,0.8); padding: 10px; border-radius: 50px;">Promo</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="main main-raised">
    <div class="container">
      <div class="section text-center">
       <?php $getBundle = $bundle->getAllBundle();
         foreach ($getBundle as $g) {
             ?>
              <a href="product.php?id=<?php echo $g['bundle_id']; ?>">
                <div class="card newArrival">
                  <h4 class="card-header card-header-info" style="overflow: hidden; text-overflow: ellipsis;"><?php echo $g['bundle_name']; ?></h4>
                  <div class="card-body">
                    <img class="card-img-top" src="assets/images/new-package-magic-300x228.jpg" alt="Card image cap" style="display: block; max-width: 100%; height: 100px;">
